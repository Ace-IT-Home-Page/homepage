...
const InfrastructureSystem = () => {
    ...
    return (
        <div className="infrastructureSystem-container py-5">
            ...
            <p className="infrastructureSystem-content text-center mb-5">{area_content}</p>
            ...
            <div className="infrastructureSystem-introduction-image-container text-center">
                <img src="/InfrastructureSystem.jpg" alt="회사 이미지" className="infrastructureSystem-introduction-company-image img-fluid"/>
            </div>
        </div>
    );
};
