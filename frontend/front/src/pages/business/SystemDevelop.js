...
const SystemDevelop = () => {
    ...
    return (
        <div className="systemDevelop-container py-5">
            ...
            >
                <h3 className="systemDevelop-title-comp-name text-center mb-5">{area_name}</h3>
                <div className="row">
                        ...
                        <div key={index} className="col-md-6 col-lg-6 mb-4">
                            <div className="systemDevelop-custom-card shadow-sm h-100">
                                <div className="d-flex align-items-center systemDevelop-custom-header mb-3">
                                    <div className="systemDevelop-section-id rounded-circle d-flex align-items-center justify-content-center mr-3">
                                        {`0${index + 1}`}
                                    </div>
